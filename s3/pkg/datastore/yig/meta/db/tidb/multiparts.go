...
func (t *Tidb) ListParts(uploadId uint64) ([]*types.PartInfo, error) {
	sqlText := "select upload_id, part_num, object_id, location, pool, offset, size, e	tag, flag, create_time, update_time from multiparts where upload_id = ? order by part_num"
