...
func (b *blockService) ListVolume(ctx context.Context, in *pb.ListVolumeRequest, out *pb.ListVolumeResponse) error {
	...
	// fetched volume details from database into a var res
...
func (b *blockService) UpdateVolume(ctx context.Context, in *pb.UpdateVolumeRequest, out *pb.UpdateVolumeResponse) error {
